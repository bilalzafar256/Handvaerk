...
| F-3104: Weekly timesheet view | `[x]` | `[x]` | `/time-tracking` route. Originally `WeeklyTimesheet`; superseded by F-3113 rebuild (`TimeTrackingShell` + `WeekBars`). |
