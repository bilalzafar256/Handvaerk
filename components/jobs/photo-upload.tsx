  ...
  return (
    <div className="space-y-3">
      ...
      <label
        ...
        className="flex items-center gap-2 h-11 px-4 rounded-[--radius-sm] border text-sm font-medium transition-colors duration-150 cursor-pointer w-fit hover:bg-[--background-subtle]"
        style={{
