  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 h-8 px-3 rounded-lg text-sm font-medium border bg-[var(--background)] hover:bg-[var(--error-light)] transition-colors cursor-pointer"
        style={{
